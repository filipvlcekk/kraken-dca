# Agent setup for `web-ui-cron-scheduler`

This is a deepsec scanning workspace. Project `web-ui-cron-scheduler` was just registered
(target: `..`). Setup is incomplete — `data/web-ui-cron-scheduler/INFO.md`
...
2. **Fill in `data/web-ui-cron-scheduler/INFO.md`.** It's auto-injected into the AI
...
```bash
pnpm deepsec scan    --project-id web-ui-cron-scheduler
pnpm deepsec process --project-id web-ui-cron-scheduler
```
